...
import { Receipt, TrendingUp, Clock, Search } from 'lucide-react-native';
  ...
  useEffect(() => {
    if (user) {
      const unsubscribe = getMerchantTransactions(user.id, (merchantTransactions) => {
        ...
        setFilteredTransactions(merchantTransactions);
      });
      return unsubscribe;
    }
  }, [user]);
  ...
  useEffect(() => {
    if (searchQuery.trim() === '') {
      ...
      const filtered = transactions.filter(transaction => 
        transaction.payerEmail.toLowerCase().includes(searchQuery.toLowerCase()) ||
      ...
      <Card>
        <View style={styles.summaryRow}>
          <View style={styles.summaryItem}>
            ...
            <Text style={styles.summaryAmount}>{formatCurrency(getTotalRevenue())}</Text>
          </View>
          <View style={styles.summaryItem}>
      ...
      <Card title="Search Payments">
        <View style={styles.searchContainer}>
          ...
          <Input
            ...
            placeholder="Search by customer email, reference, or description..."
